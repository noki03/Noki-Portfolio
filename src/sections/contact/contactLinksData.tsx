...
// 1. Add a TypeScript interface for strict typing
export interface ContactLink {
  label: string;
  href?: string; // Optional now, since email doesn't use it directly
  isEmail?: boolean; // Flag to identify our special email button
  encodedEmail?: string; // The Base64 encoded email
  filled: boolean;
  icon: ReactNode;
}
...
export const contactLinks: ContactLink[] = [
  /*  {
    label: "Email Me",
    isEmail: true,
    // This is btoa("neuqian2000@gmail.com")
    encodedEmail: "bmV1cWlhbjIwMDBAZ21haWwuY29t",
    filled: true,
    icon: (
      <svg
        aria-hidden="true"
